...
class Board:
    ...
    def move(self, piece, move, en_sound = False):
        ...
        if isinstance(piece, King):
            if self.castling(initial, final) and not en_sound:
                diff = final.col - initial.col
    ...
    def in_check(self, piece, move):
        ...
        temp_board.move(temp_piece, move, en_sound=True)
